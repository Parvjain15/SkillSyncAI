    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-cyan-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Start learning smarter — it's free</p>
        </div>
        ...
        <div className="card p-8 shadow-xl border border-gray-100">
          ...
          <div className="bg-primary-50 border border-primary-100 rounded-xl p-4 mb-6">
            <div className="flex flex-wrap gap-3">
              {['🎯 AI-powered plan', '📅 Fits your day', '🔥 Track streaks', '📊 Weekly reports'].map(b => (
                <span key={b} className="text-xs font-medium text-primary-700">{b}</span>
              ))}
            </div>
          </div>
          ...
          <div className="relative my-5">
            ...
            <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-3 text-xs text-gray-400">or sign up with email</span>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            >
              {loading ? (
                ...
                <>Create Account & Build My Plan <ArrowRight className="w-4 h-4" /></>
              )}
            </button>
          </form>
